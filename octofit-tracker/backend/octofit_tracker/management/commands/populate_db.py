...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # Create activities
        Activity.objects.create(user='Iron Man', type='run', duration=30, date='2026-03-03')
        Activity.objects.create(user='Captain America', type='cycle', duration=45, date='2026-03-02')
        Activity.objects.create(user='Batman', type='swim', duration=25, date='2026-03-01')
        Activity.objects.create(user='Superman', type='fly', duration=60, date='2026-03-03')
